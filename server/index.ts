...
// Free Ad Limit routes
import {
  getSettings as getFreeAdSettings,
  updateSettings as updateFreeAdSettings,
  checkUserFreeAdLimit,
  recordFreeAdPost,
} from "./routes/free-ad-limit";
...
export function createServer() {
  ...
  const allowedOriginPatterns = [
    ...
    // Allow Builder.io preview domains (*.net, *.com with word-word-word pattern)
    /^(https?:\/\/)?[a-z]+-[a-z]+-[a-z0-9]+\.(?:net|com)$/i,
    // Allow any subdomain of Builder.io preview domains
    /^(https?:\/\/)?([a-z0-9-]+\.)+[a-z]+-[a-z]+-[a-z0-9]+\.(?:net|com)$/i,
  ];
  ...
  // Free Ad Limit routes
  app.get(
    "/api/admin/settings/free-ad-limit",
    authenticateToken,
    requireAdmin,
    getFreeAdSettings,
  );
  app.put(
    ...
    authenticateToken,
    requireAdmin,
    updateFreeAdSettings,
  );
  app.get("/api/user/free-ad-limit", authenticateToken, checkUserFreeAdLimit);
  app.post("/api/user/record-free-ad", authenticateToken, recordFreeAdPost);
